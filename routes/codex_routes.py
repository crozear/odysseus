"""Codex integration routes — scope-gated HTTP surface for the Codex/Claude
plugin bridge (todos/notes, memory, documents, cookbook) plus skill-bundle
delivery. Email and calendar surfaces were removed from this fork."""
